...
void SceneManager::LoadSceneTextures()
{
	...
	//testing if files are there / open before anything else.  
	/*std::ifstream infile("steel2.jpg");

	if (infile.good() && infile)
	{
		std::cout << "File is good / open" << std::endl;
	}
	else
	{
		std::cout << "Not good" << std::endl;
	}
	std::ifstream infile2("stones.jpg");

	if (infile2.good() && infile2)
	{
		std::cout << "File is good / open" << std::endl;
	}
	else
	...
	*/
	...
	bReturn = CreateGLTexture("stones.jpg", "floor");
	bReturn = CreateGLTexture("steel2.jpg", "shapes");
