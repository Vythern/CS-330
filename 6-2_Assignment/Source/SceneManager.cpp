...
void SceneManager::DefineObjectMaterials()
{
	...
	goldMaterial.diffuseColor = glm::vec3(0.5f, 0.5f, 1.0f);
	...
	planeMaterial.ambientStrength = 1.1f;
	planeMaterial.diffuseColor = glm::vec3(0.2f, 0.2f, 0.2f);
	planeMaterial.specularColor = glm::vec3(0.5f, 0.5f, 0.5f);
	planeMaterial.shininess = 10.0;
	planeMaterial.tag = "gloss";
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 0.8f, 0.0f, 0.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", 5.0f, 3.0f, 5.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].specularColor", 0.0f, 0.0f, 0.8f);
